#!/bin/bash
#SBATCH -J llm_13b_num
#SBATCH --gpus 2
#SBATCH -t 3-00:00:00
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=qingwen@kth.se
#SBATCH --output /proj/berzelius-2023-154/users/x_qinzh/workspace/llc/assets/logs/%J_13b_num.out
#SBATCH --error  /proj/berzelius-2023-154/users/x_qinzh/workspace/llc/assets/logs/%J_13b_num.err
...
/proj/berzelius-2023-154/users/x_qinzh/mambaforge/envs/llc/bin/torchrun --nproc_per_node 2 --rdzv-endpoint=localhost:60012 scripts/main_codellama.py \
 ...
 --provide_detailed_explain False --provide_few_shots True --step_by_step True --num_shots 1
...
/proj/berzelius-2023-154/users/x_qinzh/mambaforge/envs/llc/bin/torchrun --nproc_per_node 2 --rdzv-endpoint=localhost:60012 scripts/main_codellama.py \
 --debug_len -1 --slurm_job_id $SLURM_JOB_ID --ckpt_dir /proj/berzelius-2023-154/users/x_qinzh/workspace/codellama/CodeLlama-13b-Instruct \
 --provide_detailed_explain False --provide_few_shots True --step_by_step True --num_shots 3

/proj/berzelius-2023-154/users/x_qinzh/mambaforge/envs/llc/bin/torchrun --nproc_per_node 2 --rdzv-endpoint=localhost:60012 scripts/main_codellama.py \
 --debug_len -1 --slurm_job_id $SLURM_JOB_ID --ckpt_dir /proj/berzelius-2023-154/users/x_qinzh/workspace/codellama/CodeLlama-13b-Instruct \
 --provide_detailed_explain False --provide_few_shots True --step_by_step True --num_shots 4