...
/proj/berzelius-2023-154/users/x_qinzh/mambaforge/envs/llc/bin/torchrun --nproc_per_node 2 scripts/main_llama.py \
 --debug_len -1 --ckpt_dir /proj/berzelius-2023-154/users/x_qinzh/workspace/codellama/CodeLlama-13b-Instruct \
